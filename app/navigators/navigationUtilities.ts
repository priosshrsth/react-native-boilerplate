...
import { type NavigationState, createNavigationContainerRef } from '@react-navigation/native';
import Config from 'src/config';
import type { PersistNavigationConfig } from 'src/config/config.base';
 ...
 */
export function getActiveRouteName(state: ReturnType<typeof navigationRef.getRootState>): keyof AppStackParamList {
